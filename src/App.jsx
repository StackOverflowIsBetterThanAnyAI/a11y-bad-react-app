  ...
  return (
    <div className="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">We make things. Probably good things.</p>
        {/*
...
function Products() {
  const items = [
    { id: 1, name: 'Widget Pro', price: '$49', img: 'https://picsum.photos/seed/w1/200/150' },
    { id: 2, name: 'Gadget Plus', price: '$99', img: 'https://picsum.photos/seed/w2/200/150' },
    { id: 3, name: 'Doohickey X', price: '$199', img: 'https://picsum.photos/seed/w3/200/150' },
  ]
        ...
        {items.map(item => (
          <div key={item.id} className="card">
            ...
            <div className="card-body">
               ...
               * WCAG:    4.1.2 Name, Role, Value (Level A)
               */}
              <button className="icon-btn" onClick={() => alert(`Added ${item.name}`)}>
                🛒
              </button>
              {/*
  ...
  return (
    <div className="section">
      ...
      <table className="pricing-table">
        ...
        <tbody>
          <tr>
            <td>Free</td><td>$0</td><td>1 GB</td><td>Community</td>
          </tr>
          <tr>
            <td>Pro</td><td>$9/mo</td><td>50 GB</td><td>Email</td>
          </tr>
          <tr>
            <td>Enterprise</td><td>$49/mo</td><td>1 TB</td><td>24/7 Phone</td>
          </tr>
        </tbody>
      </table>
    </div>
...
function ContactForm() {
  ...
  if (submitted) return <p className="success-msg">Thanks! We'll be in touch.</p>
  ...
  return (
    ...
    <div className="ticker-wrap">
      <div className="ticker">
        <span>🔥 Flash Sale — 50% off everything! &nbsp;&nbsp;&nbsp;</span>
        <span>🔥 Flash Sale — 50% off everything! &nbsp;&nbsp;&nbsp;</span>
        <span>🔥 Flash Sale — 50% off everything! &nbsp;&nbsp;&nbsp;</span>
      </div>
    </div>
...
const ISSUES = [
  ...
  { n: 18, label: 'Error message not associated to input (no aria-describedby)' },
    ...
    <aside className="legend">
      ...
      {open && (
        <ol className="legend-list">
          {ISSUES.map(i => (
            <li key={i.n}><strong>#{i.n}</strong> — {i.label}</li>
          ))}
        </ol>
      )}
    </aside>
